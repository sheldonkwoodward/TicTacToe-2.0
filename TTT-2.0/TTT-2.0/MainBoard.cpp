...
void MainBoard::showBoard()
{
	...
	/*
	cout << "                " << (char)186 << "                 " << (char)186 << "                " << endl;
	cout << "   " << miniBoards[0][0].getVal(0, 0) << " | " << miniBoards[0][0].getVal(1, 0) << " | " << miniBoards[0][0].getVal(2, 0) << "    " << (char)186 << "    " << miniBoards[0][1].getVal(0, 0) << " | " << miniBoards[0][1].getVal(1, 0) << " | " << miniBoards[0][1].getVal(2, 0) << "    " << (char)186 << "    " << miniBoards[0][2].getVal(0, 0) << " | " << miniBoards[0][2].getVal(1, 0) << " | " << miniBoards[0][2].getVal(2, 0) << "   " << endl;
	cout << "  ---|---|---   " << (char)186 << "   ---|---|---   " << (char)186 << "   ---|---|---  " << endl;
	cout << "   " << miniBoards[0][0].getVal(0, 1) << " | " << miniBoards[0][0].getVal(1, 1) << " | " << miniBoards[0][0].getVal(2, 1) << "    " << (char)186 << "    " << miniBoards[0][1].getVal(0, 1) << " | " << miniBoards[0][1].getVal(1, 1) << " | " << miniBoards[0][1].getVal(2, 1) << "    " << (char)186 << "    " << miniBoards[0][2].getVal(0, 1) << " | " << miniBoards[0][2].getVal(1, 1) << " | " << miniBoards[0][2].getVal(2, 1) << "   " << endl;
	cout << "  ---|---|---   " << (char)186 << "   ---|---|---   " << (char)186 << "   ---|---|---  " << endl;
	cout << "   " << miniBoards[0][0].getVal(0, 2) << " | " << miniBoards[0][0].getVal(1, 2) << " | " << miniBoards[0][0].getVal(2, 2) << "    " << (char)186 << "    " << miniBoards[0][1].getVal(0, 2) << " | " << miniBoards[0][1].getVal(1, 2) << " | " << miniBoards[0][1].getVal(2, 2) << "    " << (char)186 << "    " << miniBoards[0][2].getVal(0, 2) << " | " << miniBoards[0][2].getVal(1, 2) << " | " << miniBoards[0][2].getVal(2, 2) << "   " << endl;
	cout << "                " << (char)186 << "                 " << (char)186 << "                " << endl;
	...
	cout << "                " << (char)186 << "                 " << (char)186 << "                " << endl;
	cout << "   " << miniBoards[1][0].getVal(0, 0) << " | " << miniBoards[1][0].getVal(1, 0) << " | " << miniBoards[1][0].getVal(2, 0) << "    " << (char)186 << "    " << miniBoards[1][1].getVal(0, 0) << " | " << miniBoards[1][1].getVal(1, 0) << " | " << miniBoards[1][1].getVal(2, 0) << "    " << (char)186 << "    " << miniBoards[1][2].getVal(0, 0) << " | " << miniBoards[1][2].getVal(1, 0) << " | " << miniBoards[1][2].getVal(2, 0) << "   " << endl;
	cout << "  ---|---|---   " << (char)186 << "   ---|---|---   " << (char)186 << "   ---|---|---  " << endl;
	cout << "   " << miniBoards[1][0].getVal(0, 1) << " | " << miniBoards[1][0].getVal(1, 1) << " | " << miniBoards[1][0].getVal(2, 1) << "    " << (char)186 << "    " << miniBoards[1][1].getVal(0, 1) << " | " << miniBoards[1][1].getVal(1, 1) << " | " << miniBoards[1][1].getVal(2, 1) << "    " << (char)186 << "    " << miniBoards[1][2].getVal(0, 1) << " | " << miniBoards[1][2].getVal(1, 1) << " | " << miniBoards[1][2].getVal(2, 1) << "   " << endl;
	cout << "  ---|---|---   " << (char)186 << "   ---|---|---   " << (char)186 << "   ---|---|---  " << endl;
	cout << "   " << miniBoards[1][0].getVal(0, 2) << " | " << miniBoards[1][0].getVal(1, 2) << " | " << miniBoards[1][0].getVal(2, 2) << "    " << (char)186 << "    " << miniBoards[1][1].getVal(0, 2) << " | " << miniBoards[1][1].getVal(1, 2) << " | " << miniBoards[1][1].getVal(2, 2) << "    " << (char)186 << "    " << miniBoards[1][2].getVal(0, 2) << " | " << miniBoards[1][2].getVal(1, 2) << " | " << miniBoards[1][2].getVal(2, 2) << "   " << endl;
	cout << "                " << (char)186 << "                 " << (char)186 << "                " << endl;
	...
	cout << "                " << (char)186 << "                 " << (char)186 << "                " << endl;
	cout << "   " << miniBoards[2][0].getVal(0, 0) << " | " << miniBoards[2][0].getVal(1, 0) << " | " << miniBoards[2][0].getVal(2, 0) << "    " << (char)186 << "    " << miniBoards[2][1].getVal(0, 0) << " | " << miniBoards[2][1].getVal(1, 0) << " | " << miniBoards[2][1].getVal(2, 0) << "    " << (char)186 << "    " << miniBoards[2][2].getVal(0, 0) << " | " << miniBoards[2][2].getVal(1, 0) << " | " << miniBoards[2][2].getVal(2, 0) << "   " << endl;
	cout << "  ---|---|---   " << (char)186 << "   ---|---|---   " << (char)186 << "   ---|---|---  " << endl;
	cout << "   " << miniBoards[2][0].getVal(0, 1) << " | " << miniBoards[2][0].getVal(1, 1) << " | " << miniBoards[2][0].getVal(2, 1) << "    " << (char)186 << "    " << miniBoards[2][1].getVal(0, 1) << " | " << miniBoards[2][1].getVal(1, 1) << " | " << miniBoards[2][1].getVal(2, 1) << "    " << (char)186 << "    " << miniBoards[2][2].getVal(0, 1) << " | " << miniBoards[2][2].getVal(1, 1) << " | " << miniBoards[2][2].getVal(2, 1) << "   " << endl;
	cout << "  ---|---|---   " << (char)186 << "   ---|---|---   " << (char)186 << "   ---|---|---  " << endl;
	cout << "   " << miniBoards[2][0].getVal(0, 2) << " | " << miniBoards[2][0].getVal(1, 2) << " | " << miniBoards[2][0].getVal(2, 2) << "    " << (char)186 << "    " << miniBoards[2][1].getVal(0, 2) << " | " << miniBoards[2][1].getVal(1, 2) << " | " << miniBoards[2][1].getVal(2, 2) << "    " << (char)186 << "    " << miniBoards[2][2].getVal(0, 2) << " | " << miniBoards[2][2].getVal(1, 2) << " | " << miniBoards[2][2].getVal(2, 2) << "   " << endl;
	cout << "                " << (char)186 << "                 " << (char)186 << "                " << endl;
	*/
}
